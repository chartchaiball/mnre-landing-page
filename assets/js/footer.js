var footerTxt = `<div class="container">
<div class="row">
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="single-footer-widget">
            ...
            <ul class="social">
                <li><a href="https://www.facebook.com/mnreTH/" target="_blank"><i class="flaticon-facebook-letter-logo"></i></a></li>
                <li><a href="https://twitter.com/PR_MNRE" target="_blank"><i class="flaticon-twitter-black-shape"></i></a></li>
                <li><a href="https://www.youtube.com/channel/UCJtYzDvnAudN-HrHmpIYAAA" target="_blank"><i class="flaticon-youtube"></i></a></li>
            </ul>
        </div>
    </div>
...
var footer = document.getElementById("site-footerTxt");
